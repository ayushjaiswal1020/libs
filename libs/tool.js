...
function createCommand(cmd, bjs) {
  ...
  if (!cmd) {
    ...
    throw new Error(
      ...
      "Tool Lib - Command name is not specified while using funtion for creating secret command!"
  ...
  if (!bjs) {
    ...
    throw new Error(
      ...
      "Tool Lib - Command bjs is not specified while using funtion for creating secret command!"
...
function maintainence(status) {
  ...
  if (!status) {
    ...
    throw new Error(
      ...
      "Tool Lib - Status is not mentioned, mention on/off the Maintainence in ()"
  ...
  if (toDo != "on" || toDo != "off") {
    ...
    throw new Error(
      ...
      "Tool Lib - Status is not correctly mentioned, mention on/off the Maintainence in ()"
...
function verifyMinAndMax(min, max) {
  ...
  if (min > max) {
    ...
    Bot.sendMessage("Max must be greater then min")
...
function shortLink(url) {
  ...
  if (validURL(url)) {
    ...
    throw new Error(
      ...
      "Tool Lib on short link - Wrong URL\nExample : https://www.infozoxdesign.me"
